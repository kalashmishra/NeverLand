...
function color(){
    document.querySelector(".line:nth-child(1)").style.backgroundColor="#000"
    document.querySelector(".line:nth-child(2)").style.backgroundColor="#000"
    document.querySelector("#svg path").style.fill="#000"
...
function ring(){
    ...
    var clut = "";
    document.querySelector(".text2>h1").textContent.split("")
    .forEach(function(tex){
        clut += `<span>${tex}</span>`
    })
    document.querySelector(".text2>h1").innerHTML = clut
    gsap.from(".text2>h1>span",{
        scrollTrigger:{
            trigger:".text2",
            start:"top 60%",
           scrub:2,
    ...
    var clut1 = "";
    document.querySelector(".text3 h1").textContent.split("")
    .forEach(function(tex){
        clut1 += `<span>${tex}</span>`
    })
    document.querySelector(".text3 h1").innerHTML = clut1
    gsap.from(".text3 h1>span",{
        scrollTrigger:{
            trigger:".text3",
            start:"top 30%",
           scrub:2,
